...
var wikiformatterObserver =
{
    ...
    observe: function(subject, topic, data)
    {
        if(topic == "em-action-requested")
        {
            ...
            if(subject.id == WIKIFORMATTER_ID)
            {
        ...
        else if(topic == "quit-application-granted")
        {
            ...
            { // your uninstall stuff goes here
                ...
                if(typeof current_ppf != "undefined")
                {
                    ...
                    {
                        if(split_ppf[ppf].search("chrome://wikiformatter/content/formats/Wiki-formatter.js") != -1)
                        {
                ...
                branch.deleteBranch('wikiformatter'); // remove custom branch

                // Remove custom branch
                branch.deleteBranch('formats.wikiformatter'); // remove custom branch
            }
            this.unregister();
        }
    }, register: function()
...
window.addEventListener("load", initializewikiformatterObserver, false);